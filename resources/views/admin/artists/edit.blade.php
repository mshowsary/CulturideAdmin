    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.artists.update", [$artist->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{!! old('description', $artist->description) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('link_facebook') ? 'is-invalid' : '' }}" type="text" name="link_facebook" id="link_facebook" value="{{ old('link_facebook', $artist->link_facebook) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('link_twitter') ? 'is-invalid' : '' }}" type="text" name="link_twitter" id="link_twitter" value="{{ old('link_twitter', $artist->link_twitter) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('link_insta') ? 'is-invalid' : '' }}" type="text" name="link_insta" id="link_insta" value="{{ old('link_insta', $artist->link_insta) }}">
